...
<body>
    ...
    //Actividad 01
    /* 5. hacer un programa que muestre en una tabla de 4 columnas todas 
    las imágenes del directorio "fotos". En concreto la referencia de 
    funciones de directorios). Suponga que en el directorio sólo existen 
    fotos.*/
        echo '<div class="container">
                <div class="row">
                    <div class="col-lg-12">';
                    include '../Act02/header.php';
                    echo'<h1 class="text-center">Ejercicio 05</h1>';
                    ...
                    for ($col = 0; $col < 4; $col++) {
                        echo '<td>'. 
                                '<a class="selector2" href="' . $pics[$j] . '"> 
                                    <img src="' . $pics[$j] . '" alt="This Picture" width=100% height=170px/> 
                                </a> ' 
                            .'</td>';
                        $j++;
                    }        
